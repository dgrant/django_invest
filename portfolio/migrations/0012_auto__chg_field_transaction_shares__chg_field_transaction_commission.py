...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Transaction.shares'
        db.alter_column('portfolio_transaction', 'shares', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2))

        # Changing field 'Transaction.commission'
        db.alter_column('portfolio_transaction', 'commission', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Transaction.shares'
        db.alter_column('portfolio_transaction', 'shares', self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=12, decimal_places=2))

        # Changing field 'Transaction.commission'
        db.alter_column('portfolio_transaction', 'commission', self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=12, decimal_places=2))
    ...
    models = {
        ...
        'portfolio.transaction': {
            ...
            'commission': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2'}),
            ...
            'shares': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2'}),

    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "user",
                    models.ForeignKey(editable=False, to=settings.AUTH_USER_MODEL),
                ),
            ],
            options={
                "abstract": False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "exchange_rate",
                    models.DecimalField(default=1.0, max_digits=12, decimal_places=4),
                ),
                (
                    "commission",
                    models.DecimalField(
                        null=True, max_digits=12, decimal_places=2, blank=True
                    ),
                ),
                (
                    "convAmount",
                    models.DecimalField(default=0.0, max_digits=12, decimal_places=2),
                ),
                (
                    "amount",
                    models.DecimalField(default=0.0, max_digits=12, decimal_places=2),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Symbol.quote_symbol'
        db.add_column('portfolio_symbol', 'quote_symbol', self.gf('django.db.models.fields.related.ForeignKey')(related_name='related_quote_symbol', null=True, to=orm['portfolio.Symbol']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Symbol.quote_symbol'
        db.delete_column('portfolio_symbol', 'quote_symbol_id')

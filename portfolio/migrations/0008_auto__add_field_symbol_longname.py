...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Symbol.longname'
        db.add_column('portfolio_symbol', 'longname',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Symbol.longname'
        db.delete_column('portfolio_symbol', 'longname')
    ...
    models = {
        ...
        'portfolio.symbol': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'longname': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'}),

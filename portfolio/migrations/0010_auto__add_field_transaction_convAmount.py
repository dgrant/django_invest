...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.convAmount'
        db.add_column('portfolio_transaction', 'convAmount',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=12, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.convAmount'
        db.delete_column('portfolio_transaction', 'convAmount')
    ...
    models = {
        ...
        'portfolio.transaction': {
            ...
            'convAmount': ('django.db.models.fields.DecimalField', [], {'max_digits': '12', 'decimal_places': '2'}),

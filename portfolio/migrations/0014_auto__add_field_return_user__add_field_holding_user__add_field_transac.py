...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Return.user'
        db.add_column('portfolio_return', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Holding.user'
        db.add_column('portfolio_holding', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Transaction.user'
        db.add_column('portfolio_transaction', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Return.user'
        db.delete_column('portfolio_return', 'user_id')

        # Deleting field 'Holding.user'
        db.delete_column('portfolio_holding', 'user_id')

        # Deleting field 'Transaction.user'
        db.delete_column('portfolio_transaction', 'user_id')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Symbol.symbol'
        db.delete_column('portfolio_symbol', 'symbol')


    def backwards(self, orm):
        
        # Adding field 'Symbol.symbol'
        db.add_column('portfolio_symbol', 'symbol', self.gf('django.db.models.fields.CharField')(default='', max_length=20), keep_default=False)
